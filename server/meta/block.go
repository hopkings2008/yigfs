...
func(m *Meta) GetCoveredExistedBlocks(ctx context.Context, seg *types.CreateSegmentReq, startAddr, endAddr int64) (blocks map[int64][]int64, err error) {
	return m.Client.GetCoveredExistedBlocks(ctx, seg, startAddr, endAddr)
}
...
func(m *Meta) GetCoverBlocks(ctx context.Context, seg *types.CreateSegmentReq, startAddr, endAddr int64) (blocks map[int64][]int64, err error) {
	return m.Client.GetCoverBlocks(ctx, seg, startAddr, endAddr)
}
